...
insert into Producto (id,nombre,precio,descripcion,imagen,disponible,cantidad_disponible,categoria_id) values (100,'coca',5.5,'bien fresquita',null,true,12,10)
